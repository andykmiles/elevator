def collect_parameters():
    ...
    values["morning_peak_end"] = input("Morning peak ends hh:mm : ")
    values["lunch_peak_start"] = input("Lunch peak starts hh:mm : ")
    values["lunch_peak_end"] = input("Lunch peak ends hh:mm : ")
